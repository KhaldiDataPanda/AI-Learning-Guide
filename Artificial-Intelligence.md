...
- [Fast.ai Practical Deep Learning for Coders](https://course.fast.ai/) – Free, code-first course that teaches state-of-the-art DL with fastai & PyTorch.  

- [Full Stack Deep Learning Bootcamp](https://fullstackdeeplearning.com/) – Project-oriented course on shipping end-to-end ML products (MLOps, testing, deployment).  

- [DeepLearning.AI TensorFlow Developer Professional Certificate](https://www.coursera.org/professional-certificates/tensorflow-in-practice) – Build & train CNNs, RNNs, NLP models in TensorFlow.  

- [Stanford CS221: AI Principles & Techniques (YouTube playlist)](https://www.youtube.com/playlist?list=PLoROMvodv4rO1NB9TD4IUZ3aGHIVlYmVy) – Classic AI lectures covering search, MDPs, game theory, RL.  

- [MIT 6.S191 Introduction to Deep Learning](http://introtodeeplearning.com/) – One-week intensive with recorded labs on GANs, VAEs, Transformers.
...
[Yannic Kilcher](https://www.youtube.com/@YannicKilcher) – Paper-breakdowns on Transformers, LLMs, diffusion models, RL.  

[Two Minute Papers](https://www.youtube.com/@TwoMinutePapers) – Short, visual summaries of the newest AI & graphics papers.  

[DeepMind](https://www.youtube.com/@DeepMind) – Keynotes, behind-the-scenes, and open-source drop announcements. 
...
[Machine Learning Street Talk](https://www.youtube.com/@MachineLearningStreetTalk) – Deep-dive interviews with top AI researchers.  

[Gradient Dissent](https://wandb.me/gradient-dissent) – Practitioners discuss reproducibility, experiment tracking, and scaling.  

[The AI Breakdown](https://theaibreakdown.beehiiv.com/) – Daily 10-minute news brief on generative-AI breakthroughs. 
...
[Google AI Blog](https://ai.googleblog.com/) – Research releases from Google Brain, DeepMind, and product teams.  

[BAIR Blog (Berkeley AI Research)](https://bair.berkeley.edu/blog/) – Accessible posts on RL, robotics, and representation learning.  

[Lil’Log (lilianweng.github.io)](https://lilianweng.github.io) – Detailed long-form posts on diffusion, RLHF, LLM agents.  

[AssemblyAI Blog](https://www.assemblyai.com/blog/) – Tutorials on speech recognition, transformers, and audio LLMs.  
